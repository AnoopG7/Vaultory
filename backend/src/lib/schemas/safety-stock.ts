import { z } from 'zod'
import { nonNegativeQtySchema, uuidSchema } from './common.js'
...
export const upsertSafetyStockSchema = z.object({
  ...
  targetLevel: nonNegativeQtySchema,
...
export const safetyStockRuleSchema = z.object({
  ...
  safety_stock: nonNegativeQtySchema,
  reorder_point: nonNegativeQtySchema,
  target_level: nonNegativeQtySchema,
