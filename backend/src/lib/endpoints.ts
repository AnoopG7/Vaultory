...
export const SALES_ENDPOINTS: EndpointEntry[] = [
  {
    ...
    requestSchema: 'createSaleSchema',
  ...
  },
  {
    ...
    auth: true,
    requestSchema: 'listSalesQuerySchema (query)',
  ...
  },
  {
    ...
    auth: true,
    roles: ['admin', 'sales_personnel'],
    requestSchema: 'returnSaleSchema',
...
export const DASHBOARD_ENDPOINTS: EndpointEntry[] = [
  ...
  },
  {
    ...
    auth: true,
    requestSchema: 'revenueTrendQuerySchema (query)',
  ...
  },
  {
    ...
    auth: true,
    requestSchema: 'topProductsQuerySchema (query)',
  ...
  },
  {
    ...
    auth: true,
    requestSchema: 'storeComparisonQuerySchema (query)',
